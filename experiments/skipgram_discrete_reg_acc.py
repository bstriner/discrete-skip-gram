...
from discrete_skip_gram.skipgram.tree_parameterization import ParameterizationReg
...
def main():
    ...
    outputpath = "output/skipgram_discrete_reg_acc"
    z_depth = 10
    z_k = 2
    epochs = 1000
    batches = 64
    ...
    model = DiscreteFullAccModel(cooccurrence=cooccurrence,
                                 ...
                                 param_class=ParameterizationReg,
