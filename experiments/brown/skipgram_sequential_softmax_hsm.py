...
from discrete_skip_gram.models.word_skipgram_sequential_softmax_hsm import WordSkipgramSequentialSoftmaxHSM
from random_hsm import load_hsm
from sample_validation import validation_load


def main():
    outputpath = "output/brown/skipgram_sequential_softmax_hsm"
    ...
    model = WordSkipgramSequentialSoftmaxHSM(dataset=dataset,
                                             hsm=hsm,
                                             schedule=schedule,
                                             z_k=z_k,
                                             z_depth=z_depth,
