...
from discrete_skip_gram.models.word_skipgram_sequential_continuous import WordSkipgramSequentialContinuous
from discrete_skip_gram.models.util import makepath


def main():
    outputpath = "output/brown/skipgram_sequential_continuous"
    min_count = 5
    batch_size = 64
    epochs = 1000
    ...
    ds.summary()
    model = WordSkipgramSequentialContinuous(ds, z_k = z_k, z_depth=z_depth, hidden_dim=hidden_dim)
