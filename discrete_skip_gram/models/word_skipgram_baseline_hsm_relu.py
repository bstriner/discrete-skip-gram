...
from ..layers.skipgram_hsm_layer_relu import SkipgramHSMLayerRelu, SkipgramHSMPolicyLayerRelu
from ..layers.utils import drop_dim_2


class WordSkipgramBaselineHSMRelu(SGModel):
    def __init__(self,
                 dataset,
                 units,
                 window,
        ...
        skipgram = SkipgramHSMLayerRelu(units=units,
        ...
        policy = SkipgramHSMPolicyLayerRelu(skipgram, srng=srng,
